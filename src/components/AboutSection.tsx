...
import { ArrowUpRight, Award, Compass, Cpu, Sparkles, Terminal } from 'lucide-react';
...
export const AboutSection: React.FC<AboutSectionProps> = ({ onOpenContact, onNavigate }) => {
  return (
    <section
      id="about"
