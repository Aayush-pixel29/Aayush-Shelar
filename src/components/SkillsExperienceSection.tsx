...
import { Cpu, Layers, Terminal, Server, Briefcase, CheckCircle, ExternalLink } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        {/* Currently Open Callout Banner */}
        <div className="mt-24 p-8 sm:p-12 rounded-[40px] border border-white/15 bg-gradient-to-r from-white/[0.04] to-white/[0.01] flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div>
            <div className="flex items-center gap-2 text-xs uppercase tracking-widest text-[#BBCCD7] font-semibold mb-2">
            ...
            <p className="text-sm sm:text-base text-[#D7E2EA]/75 font-light mt-2 max-w-2xl">
          ...
          <ContactButton onClick={() => onOpenContact()} label="Start a Conversation" />
        </div>
      </div>
    </section>
  );
